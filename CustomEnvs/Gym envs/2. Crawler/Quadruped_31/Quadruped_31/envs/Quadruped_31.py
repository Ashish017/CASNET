...
class model_data:
	...
	def __init__(self):
		...
		self.joint_ranges = [[[-0.3490, 0.3490],[0.5235, 1.57]],[[-0.5234, 0.5234],[0.1745, 1.57]],[[-0.5234, 0.5234],[0.1745, 1.57]],[[-0.5234, 0.5234],[0.2617, 1.4835]]]
...
class Quadruped_v31(mujoco_env.MujocoEnv, utils.EzPickle):
	def __init__(self, add_dummy=False, max_segments=3, max_legs=6):
		...
		mujoco_env.MujocoEnv.__init__(self, 'Quadruped_31.xml', 5)
