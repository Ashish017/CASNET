...
class model_data:
	...
	def __init__(self):
		self.num_legs = 6
		self.leg_lengths = [[0.21, 0.6],[0.37, 0.6],[0.3, 0.6],[0.3, 0.6],[0.3, 0.6],[0.42, 0.6]]
...
class Hexapod_v41(mujoco_env.MujocoEnv, utils.EzPickle):
	def __init__(self, add_dummy=False, max_segments=3, max_legs=6):
		...
		mujoco_env.MujocoEnv.__init__(self, 'Hexapod_41.xml', 5)
