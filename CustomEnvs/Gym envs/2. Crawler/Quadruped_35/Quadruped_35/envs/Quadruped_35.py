...
class model_data:
	...
	def __init__(self):
		...
		self.joint_ranges = [[[-0.5234, 0.5234],[-0.3490, 1.0472]],[[0.0, 0.6981],[0.0, 1.309]],[[-0.5234, 0.5234],[0.1745, 1.57]],[[-0.5234, 0.5234],[0.1745, 1.57]]]
...
class Quadruped_v35(mujoco_env.MujocoEnv, utils.EzPickle):
	def __init__(self, add_dummy=False, max_segments=3, max_legs=6):
		...
		mujoco_env.MujocoEnv.__init__(self, 'Quadruped_35.xml', 5)
