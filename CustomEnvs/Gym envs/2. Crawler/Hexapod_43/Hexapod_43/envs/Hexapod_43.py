...
class model_data:
	...
	def __init__(self):
		self.num_legs = 6
		self.leg_lengths = [[0.3, 0.6],[0.3, 0.6],[0.25, 0.6],[0.3, 0.6],[0.39, 0.44],[0.3, 0.6]]
...
class Hexapod_v43(mujoco_env.MujocoEnv, utils.EzPickle):
	def __init__(self, add_dummy=False, max_segments=3, max_legs=6):
		...
		mujoco_env.MujocoEnv.__init__(self, 'Hexapod_43.xml', 5)
