...
class model_data:
	...
	def __init__(self):
		self.num_legs = 6
		self.leg_lengths = [[0.3, 0.6],[0.3, 0.6],[0.3, 0.34],[0.3, 0.6],[0.3, 0.72],[0.3, 0.18]]
		...
		self.joint_axes = [[[0, 0, 1],[0, 1, 0]],[[0, 0, 1],[0, 1, 0]],[[0, 0, 1],[0, 1, 0]],[[0, 0, -1],[0, -1, 0]],[[0, 0, -1],[0, -1, 0]],[[0, 0, -1],[0, -1, 0]]]
...
class Hexapod_v42(mujoco_env.MujocoEnv, utils.EzPickle):
	def __init__(self, add_dummy=False, max_segments=3, max_legs=6):
		...
		mujoco_env.MujocoEnv.__init__(self, 'Hexapod_42.xml', 5)
