...
class model_data:
    ...
    def __init__(self):
        self.num_links = 6
        self.link_lengths = [0.1,0.12,0.08,0.13,0.07,0.14]
...
class Reacher_v62(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self, add_dummy=False, max_links=5):
        ...
        mujoco_env.MujocoEnv.__init__(self, 'Reacher_62.xml', 2)
