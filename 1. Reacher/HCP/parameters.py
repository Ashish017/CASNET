...
class Settings:
	...
	def __init__(self):
		...
		self.testing_envs = ["Reacher-v11", "Reacher-v12","Reacher-v21", "Reacher-v22","Reacher-v31", "Reacher-v32","Reacher-v41", "Reacher-v42","Reacher-v51", "Reacher-v52"]

		self.max_links = 5	#Variable just to make our life easier
		self.save_freq = 100
